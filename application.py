...
from helpers import apology, login_required, get_entities_dict, get_sentiment, spelling
...
def stats():
    ...
    entities = get_entities_dict(text_combined)
    print(entities)
    ...
    return render_template("stats.html", basics_facts=basics_facts, suggestions=suggestions, sentiment=sentiment, entities=entities, paragraphs=paragraphs, facts=facts, text_combined=text_combined)
